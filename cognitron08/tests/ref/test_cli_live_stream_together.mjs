...
if (!process.env.TOGETHER_API_KEY) { console.log('SKIP ref_cli_live_stream_together (no TOGETHER_API_KEY)'); process.exit(0); }
...
console.log('OK ref_cli_live_stream_together');
